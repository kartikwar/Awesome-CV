...
%---------------------------------------------------------
    ...
    {Sept 2020 - July 2024} % Date
    {
      ...
      Led development of a high‐volume background removal API for \ulhref{https://backgroundly.io/}{backgroundly.io},  
      ...
      \newline 
      Integrated open‐source \ulhref{https://www.cs.cornell.edu/projects/megadepth/}{MegaDepth model} with in‐house background removal services.
      \newline
